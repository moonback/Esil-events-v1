    ...
    return (
      <div className="mt-4 space-y-6">
        <div className="text-center mb-6">
          <h3 className="text-xl font-semibold text-gray-800">Suggestions personnalisées</h3>
          <p className="text-sm text-gray-500 mt-1">Basées sur vos besoins et préférences</p>
        </div>
            ...
            <div className="p-4">
              <div className="flex gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-semibold text-lg text-gray-800 mb-1">{suggestion.name}</h4>
              ...
              {suggestion.type === 'package' && suggestion.items_included && (
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <h5 className="text-sm font-medium text-gray-700 mb-2">Contenu du package :</h5>
        ...
        {additionalTips && (
          <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-100">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium text-blue-800 mb-1">Conseil supplémentaire</h4>
                <p className="text-sm text-blue-600">{additionalTips}</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="flex flex-wrap gap-2">
            {currentQuestion.options?.map((option) => (
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-sm hover:shadow-md"
              >
                {option}
              </button>
            ))}
      ...
      case 'text':
        return (
          <div className="flex gap-2">
            <input
              type="text"
              className="px-4 py-2 border border-gray-200 rounded-lg flex-grow focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed ${isMaximized ? 'inset-4' : 'bottom-24 right-6 w-[420px]'} h-[600px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 overflow-hidden border border-gray-100`}
          >
            {/* Chat header */}
