...
/>
                ...
                >
                  ...
                  <a href="https://twitter.com/esilevents" target="_blank" rel="noopener noreferrer" 
                    className="p-2 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all duration-300 transform hover:scale-110 group"
                    aria-label="Twitter">
                    <svg className="w-5 h-5 text-blue-400 dark:text-blue-300 group-hover:text-blue-500 dark:group-hover:text-blue-200 transition-colors duration-300" 
                      fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
