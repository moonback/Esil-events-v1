      ...
      >
        <div className="w-full mx-auto">
          <div className="flex flex-col relative">
            ...
            <div className="absolute left-2 sm:left-4 top-4 sm:top-5 z-10">
              <Link to="/" className="flex items-center group">
                {/* Desktop version */}
                <img 
                  src="images/logo.png" 
                  alt="ESIL Events Logo" 
                  className="hidden md:block h-14 sm:h-16 lg:h-20 w-14 sm:w-16 lg:w-20 transition-all duration-300 transform group-hover:scale-105 hover:rotate-3 filter drop-shadow-lg"
                />
                {/* Mobile version */}
                <img 
                  src="images/logo.png" 
                  alt="ESIL Events Logo" 
                  className="md:hidden h-7 w-7 sm:h-10 sm:w-10 mt-[45px] sm:mt-[55px] transition-all duration-300 transform group-hover:scale-105 hover:rotate-3 filter drop-shadow-lg"
                />
              </Link>
            </div>

            {/* Search Bar Section */}
            <div className="w-full py-1.5 sm:py-2 md:py-3 border-b border-gray-200/60 dark:border-gray-700/60">
              <div className="px-2 sm:px-4 flex items-center justify-center">
                <div className="flex-1 max-w-2xl sm:max-w-3xl relative">
                  <SearchBar 
                ...
                <div className="hidden md:flex space-x-1.5 sm:space-x-2 ml-3 sm:ml-4">
                  <a 
                    href="tel:07.85.95.97.23" 
                    className="flex items-center space-x-1.5 sm:space-x-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-full bg-primary-50/80 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 hover:bg-primary-100 dark:hover:bg-primary-900/30 transition-all duration-300 transform hover:scale-105 hover:shadow-md hover:ring-2 hover:ring-primary-500/30"
                  >
                ...
                <div className="hidden md:flex space-x-2 sm:space-x-3 ml-2 sm:ml-3">
                  <a href="https://www.facebook.com/profile.php?id=61574583021091" target="_blank" rel="noopener noreferrer" 
                    className="p-1.5 sm:p-2 rounded-full hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all duration-300 transform hover:scale-110 hover:shadow-md group"
                    aria-label="Facebook">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-blue-400 group-hover:text-blue-700 dark:group-hover:text-blue-300 transition-colors duration-300" 
                  ...
                  <a href="https://www.instagram.com/esilevents" target="_blank" rel="noopener noreferrer" 
                    className="p-1.5 sm:p-2 rounded-full hover:bg-pink-100 dark:hover:bg-pink-900/30 transition-all duration-300 transform hover:scale-110 hover:shadow-md group"
                    aria-label="Instagram">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-pink-600 dark:text-pink-400 group-hover:text-pink-700 dark:group-hover:text-pink-300 transition-colors duration-300" 
                      fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            {/* Main Navigation */}
            <div className="flex items-center h-10 sm:h-12 md:h-14 px-2 sm:px-4">
              {/* Spacer for logo */}
              <div className="w-14 sm:w-16 md:w-24"></div>

              <div className="flex-1 flex justify-center">
                <nav className="hidden md:flex items-center space-x-3 sm:space-x-4 lg:space-x-8">
                  ...
                  <div className="relative group mega-menu-container">
                    ...
                    {showMegaMenu && (
                      <div
                        ...
                        onMouseLeave={() => setShowMegaMenu(false)}
                      >
                        <div className="max-w-12xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
