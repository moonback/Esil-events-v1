...
const MobileSidebar: React.FC<MobileSidebarProps> = ({ 
  ...
  return (
    <>
      ...
      <div 
        className={`fixed inset-0 bg-black/40 backdrop-blur-md z-[90] md:hidden transition-opacity duration-300 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        onClick={onClose}
      />
      
      {/* Sidebar - From top with improved glassmorphism and animations */}
      <div 
        className={`fixed top-0 left-0 right-0 w-full h-auto max-h-[90vh] overflow-y-auto glassmorphism dark:bg-gray-900/90 z-[100] md:hidden transform transition-all duration-500 ease-out ${
          isOpen ? 'translate-y-0 opacity-100 rounded-b-2xl' : '-translate-y-full opacity-0'
        } shadow-2xl border-b border-gray-200/20 dark:border-gray-700/20`}
      >
        {/* Header with gradient background */}
        <div className="flex justify-between items-center p-4 border-b border-gray-200/30 dark:border-gray-700/30 bg-gradient-to-r from-violet-50/80 to-indigo-50/80 dark:from-violet-900/20 dark:to-indigo-900/20">
          <div className="flex items-center space-x-3">
            <img 
              src="/images/logo.png" 
              alt="ESIL Events Logo" 
              className="h-10 w-10 rounded-lg shadow-md transform transition-all duration-300 hover:rotate-3 hover:scale-110"
            />
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-full bg-white/80 dark:bg-gray-800/80 hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:rotate-90 shadow-sm hover:shadow-md"
        ...
        {user && (
          <div className="px-4 py-3 bg-gradient-to-r from-violet-50/90 to-purple-50/90 dark:from-violet-900/30 dark:to-purple-900/30 border-b border-gray-200/30 dark:border-gray-700/30">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 shadow-lg flex items-center justify-center transform transition-all duration-300 hover:rotate-3 hover:scale-105">
        ...
        <div className="px-2 py-3 space-y-3 overflow-y-auto">
          {/* Main navigation - with improved styling and animations */}
          <div className="mb-5 bg-white/50 dark:bg-gray-800/30 rounded-xl p-3 shadow-sm">
          ...
          <div className="mb-2 bg-gradient-to-r from-violet-50/80 to-indigo-50/80 dark:from-violet-900/20 dark:to-indigo-900/20 rounded-xl p-4 shadow-sm">
            ...
            <div className="flex space-x-3 mt-4">
              <a 
                ...
                className="p-2.5 rounded-lg bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-800/30 transition-all duration-300 transform hover:scale-110 hover:shadow-md"
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2.5 rounded-lg bg-pink-50 dark:bg-pink-900/20 text-pink-600 dark:text-pink-400 hover:bg-pink-100 dark:hover:bg-pink-800/30 transition-all duration-300 transform hover:scale-110 hover:shadow-md"
