                ...
                <div className="grid grid-cols-1 md:grid-cols-12">
                    ...
                    <div className="h-full min-h-64 bg-gradient-to-br from-violet-600 to-indigo-800 relative overflow-hidden">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                        <div className="flex space-x-3 mb-3">
                          <a href="#" className="text-white hover:text-violet-300 transition-colors">
                  ...
                  <div className="p-8 md:col-span-7">
                    <div className="flex flex-col h-full">
                      ...
                      <div className="mt-6">
                        <button className="inline-flex items-center text-sm font-medium text-violet-600 dark:text-violet-400 hover:text-violet-800 dark:hover:text-violet-300 transition-colors">
                          Contacter
      ...
      >
        ...
        <div className="max-w-12xl mx-auto px-6 relative z-10">
          <motion.div 
            ...
            variants={fadeInUp}
          >
            <span className="inline-block text-sm font-semibold text-violet-400 uppercase tracking-wider mb-2">Ils nous font confiance</span>
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto">
              ...
              pour organiser des événements mémorables qui ont marqué les esprits.
            </p>
          </motion.div>
